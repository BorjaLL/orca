    ...
    <div className="relative">
      ...
      {open && (
        <div
          ...
          className="scrollbar-sleek absolute right-0 top-9 z-30 max-h-72 w-56 overflow-y-auto rounded-lg border border-border/60 bg-popover p-1 text-popover-foreground shadow-md"
